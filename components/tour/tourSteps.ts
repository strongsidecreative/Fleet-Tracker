...
export const adminTourSteps: TourStep[] = [
  ...
  },
  {
    id: "nav-drivers",
    path: "/admin",
    target: "[data-tour='nav-admin-drivers']",
    title: "Drivers",
    content: "Manage driver profiles and licence details, and add new drivers to the fleet.",
    placement: "auto",
  },
  {
    id: "nav-admins",
    path: "/admin",
    target: "[data-tour='nav-admin-admins']",
    title: "Admins",
    content: "See and manage who else has admin access to Fleet Tracker.",
    placement: "auto",
  },
  {
    id: "nav-bookings",
  ...
  },
  {
    ...
    title: "Records",
    content: "A searchable log of every completed trip across the whole fleet, exportable to CSV.",
    placement: "auto",
  },
  {
    id: "nav-sessions",
    path: "/admin",
    target: "[data-tour='nav-admin-sessions']",
    title: "Sessions",
    content: "See vehicles currently checked out, and close out a trip on a driver's behalf if needed.",
    placement: "auto",
  },
  {
    id: "nav-audit",
